...
# ============================================================
# IP-/STANDORT-DATEN FÜR DEN BOT (User-ID -> Geo-Daten)
# Der Bot fragt diese über /ipdata ab.
# ============================================================
IPDATA = {}
IPDATA_MAX = 5000  # einfache Größenbegrenzung
...
# ============================================================
# NEU: IP-DATEN FÜR DEN BOT ABFRAGEN
# Aufruf durch den Bot: GET /ipdata?user_id=123456789
# ============================================================
@app.route("/ipdata")
def ipdata():
...
def _send_visitor_log(data):
    """Hintergrund-Thread: Geo-Abfrage + Webhook-POST + Speichern für den Bot."""
    try:
        ip = data["ip"]
        ...
        # ======================================================
        # NEU: Wenn die User-ID bekannt ist (nach OAuth-Verify),
        # die Daten für den Bot speichern (unter der User-ID)
        # ======================================================
        uid = data.get("uid") or ""
        if uid:
            IPDATA[uid] = {
            ...
            # Größenbegrenzung: älteste Einträge rauswerfen
